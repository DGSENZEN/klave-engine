...
def build_default_catalog(a: CostingAssumptions) -> list[Concept]:
    ...
    return [
        ...
        Concept(
            ...
            assumptions=[
                f"Sección promedio {a.column_section_m2:.3f} m²",
                f"Altura de entrepiso {a.column_height_m:.2f} m",
                "Cantidad basada en etiquetas detectadas (verificar repeticiones "
                "entre vistas del plano)",
            ],
        ...
        Concept(
            ...
            quantity_factor=1.0,
            assumptions=["Área medida de regiones de losa detectadas"],
